...
export const mockNotifications: Notification[] = [
  {
    ...
    message: 'Jan Kowalski złożył aplikację na zgłoszenie "Sprzątanie klatek schodowych"',
    type: 'application',
  ...
  },
  {
    ...
    message: 'Gratulacje! Twoja aplikacja na zgłoszenie "Serwis instalacji elektrycznej" została zaakceptowana',
    type: 'success',
    category: 'application',
    read: true,
  ...
  },
  {
    id: 'notif-5',
    userId: '1',
    title: 'Zgłoszenie wygasło',
    message: 'Zgłoszenie "Malowanie klatek schodowych" wygasło. Nie otrzymano żadnych aplikacji.',
    type: 'warning',
    category: 'job',
    read: true,
  ...
  },
  {
    ...
    message: 'Pamiętaj o opłaceniu faktury za zgłoszenie "Sprzątanie klatek schodowych"',
    type: 'warning',
    category: 'job',
    read: false,
