...
export const jobListMockData: JobMock[] = [
  {
    ...
    salary: '45-60 zł/h',
    description: 'Poszukujemy rzetelnej firmy sprzątającej do regularnego utrzymania czystości w klatkach schodowych budynków mieszkalnych. Zgłoszenie obejmuje mycie podłóg, schodów, okien oraz odkurzanie.',
    requirements: [
  ...
  },
  {
    ...
    salary: '80-120 zł/m²',
    description: 'Zgłoszenie na kompleksowy remont elewacji 4-piętrowego budynku mieszkalnego. Wymaga oczyszczenia, gruntowania, malowania oraz naprawy drobnych uszkodzeń. Powierzchnia do remontu: ok. 800m².',
    requirements: [
  ...
  },
  {
    ...
    type: 'Jednorazowe zgłoszenie',
    salary: '1500-2500 zł',
    description: 'Zgłoszenie na wykonanie rocznego przeglądu technicznego budynku mieszkalnego według rozporządzenia o warunkach technicznych. Konieczne uprawnienia budowlane i doświadczenie w ocenie stanu technicznego.',
