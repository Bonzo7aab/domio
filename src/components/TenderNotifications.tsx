...
// Mock notifications for contractors
const mockNotifications: TenderNotification[] = [
  {
    id: 'tender-notif-1',
    type: 'new_tender',
...
export const TenderNotifications: React.FC<TenderNotificationsProps> = ({
  ...
  const [notifications, setNotifications] = useState<TenderNotification[]>(mockNotifications);
